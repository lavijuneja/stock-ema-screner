...
try:
    ...
    st.error("❌ config.yaml file नहीं मिली! Folder में config.yaml बनाओ।")
    st.stop()

# Create authenticator object (without deprecated preauthorized parameter)
try:
    ...
    st.info("💡 Terminal में यह command चलाओ: pip install streamlit-authenticator==0.2.1")
    st.stop()
